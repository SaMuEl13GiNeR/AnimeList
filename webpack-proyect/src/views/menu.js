    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active" id="home_link" aria-current="page" href="#">Home</a>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" id="listaAnime_link" href="#">Anime</a></li>
                        <li><a class="dropdown-item" href="#">Manga</a></li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        <li><a class="dropdown-item" href="#">Modificar listas</a></li>
                    </ul>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                <a id="user" class="nav-link disabled"></a>
                </li>
            </ul>
            <form class="d-flex">
